...
const ThemeSettings = () => {
  ...
  return (
    <div className="theme-settings">
      ...
      <Paragraph>
        Customize the look and feel of your ThingsBoard application. These settings will be saved to your browser and
        ...
        <Col xs={24} md={12}>
          <Card title="Theme Mode" bordered={false} className="settings-section-card">
            ...
            <div className="auto-detect-option">
              ...
              <Text style={{ marginLeft: 8 }}>Auto-detect from system preferences</Text>
            </div>
          </Card>
        </Col>
        ...
        <Col xs={24} md={12}>
          <Card title="Primary Color" bordered={false} className="settings-section-card">
            <div className="color-picker-container">
              <ColorPicker value={selectedColor} onChange={handleColorChange} showText />
              <Text style={{ marginLeft: 16 }}>Select a primary color for buttons, links, and accents</Text>
            </div>
